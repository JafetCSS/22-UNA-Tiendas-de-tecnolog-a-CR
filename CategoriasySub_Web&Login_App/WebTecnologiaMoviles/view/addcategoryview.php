            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="../business/categoryaction.php" method="POST" id="category-form" class="form-inline" onsubmit="return validate();">
                            <div class="form-group">
                                <input class="form-control mr-sm-4" type="text" name="category_name" id="category_name" placeholder="Nombre Categor&iacute;a">
                            </div>
                            <div class="form-group">
                                <select class="form-control pl-0 mr-sm-3" id="category" name="category">
                            ...
                            <button type="submit" name="create" class="btn btn-success text-center ml-sm-3">Insertar</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <tbody>
                    <?php foreach ($allcategories as $category) { ?>
                        ...
                        <tr>
                            ...
                            <td><select name="category" id="category" class="form-control pl-0">
                            ...
                            <td>
                                <input type="submit" value="Actualizar" name="update" id="update" class="btn btn-warning btn-edit" />
                                <input type="submit" value="Eliminar" name="delete" id="delete" class="btn btn-danger btn-delete ml-2" />
                            </td>
                        </tr>
                        <?php echo '</form>' ?>
                    <?php
